...
int initialize_cube(object3d_t* cubeobj, texturemanager_t* tm)
{
    int is_success;
#ifdef GLIDE_BUILD
  const textureconfig_t configs[20] = {
      { "assets/textures/camino2.pcx", LOAD_FILE },
      { "assets/textures/floor_g.pcx", LOAD_FILE },
      { "assets/textures/metal.pcx", LOAD_FILE },
      { "assets/textures/trak_g.pcx", LOAD_FILE },
      { "assets/textures/univ42.pcx", LOAD_FILE },
      { "assets/textures/univ43.pcx", LOAD_FILE } };
#else
  const textureconfig_t configs[20] = {
      { "assets/textures/s_camino.pcx", LOAD_FILE },
      { "assets/textures/s_floorg.pcx", LOAD_FILE },
      { "assets/textures/s_metal.pcx", LOAD_FILE },
      { "assets/textures/s_trakg.pcx", LOAD_FILE },
      { "assets/textures/s_univ2.pcx", LOAD_FILE },
      { "assets/textures/s_univ3.pcx", LOAD_FILE } };
#endif
